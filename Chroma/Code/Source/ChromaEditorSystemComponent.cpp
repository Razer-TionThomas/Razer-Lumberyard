		...
		if (AZ::SerializeContext* serialize = azrtti_cast<AZ::SerializeContext*>(context))
		{
			...
			if (AZ::EditContext* ec = serialize->GetEditContext())
			{
				ec->Class<ChromaEditorSystemComponent>("Chroma", "Adds Chroma lighting effects to game objects")
					...
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::stopEffect, "Stop Effect", "Stop the current animation")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::StopEffect)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::clearEffects, "Clear Effects", "Clear All Chroma Devices")
					...
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::playPresetEffect, "Play Preset Effect", "Plays selected preset effect")
					...
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::setKey, "Set Key Color", "Color Selected Key")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::SetKey)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::setLed, "Set Led Color", "Color Selected Key")
					...
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::setRow, "Paint Row", "Color Entire Row On Keyboard")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::PaintRow)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::setCol, "Paint Column", "Color Entire Column On Keyboard")
					...
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::nextFrame, "Next Frame", "Move to next frame in animation")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::NextFrame)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::prevFrame, "Prev Frame", "Move to previous frame in animation")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::PreviousFrame)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::copyFrame, "Copy Frame", "Copy Contents of Current Chroma Frame")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::CopyFrame)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::pasteFrame, "Paste Frame", "Paste Contents of Current Chroma Frame")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::PasteFrame)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::fillFrame, "Fill Frame", "Color all Device Leds Selected Color")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::FillFrame)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::clearFrame, "Clear Frame", "Clears the current chroma frame")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::ClearFrame)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::addFrame, "Add Frame", "Adds a new frame to the animation")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::AddFrame)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::deleteFrame, "Delete Frame", "Deletes the current frame from the animation")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::DeleteFrame)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::resetAnimation, "Reset Animation", "Clears all frames and resets frame count to 1")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::ResetAnimation)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::importImage, "Import Image", "Import jpg, png, bmp")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::LoadSingleImage)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::importAnimation, "Import Animation", "Import gif animations")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::LoadAnimation)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::playCustomEffect, "Play Custom Single Device", "Plays currrent device custom animation frames")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::PlayCustomAnimation)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::playAllCustomEffect, "Play Custom All Devices", "Plays custom animation on all devices simultaneously")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::PlayAllCustomAnimation)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::importEffect, "Import Effect", "Imports existing .chroma effect file into the Lumberyard editor")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::ImportChromaEffect)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::exportEffect, "Export Effect", "Creates .chroma effect file for current effect")
						->Attribute(AZ::Edit::Attributes::ChangeNotify, &ChromaEditorSystemComponent::ExportChromaEffect)
					->DataElement(AZ::Edit::UIHandlers::Button, &ChromaEditorSystemComponent::exportHeader, "Export Header File", "Exports current animation color buffer into .h file")
